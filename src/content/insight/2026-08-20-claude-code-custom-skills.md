...
덴마크 산업기기 기업 댄포스(Danfoss)는 거래성 의사결정의 최대 80%를 AI 에이전트에 맡기면서 고객 응답 시간을 42시간에서 거의 실시간 수준으로 줄여 가고 있다. 캐나다 통신사 텔러스(Telus)는 직원 5만7천여 명이 AI를 쓰면서 상호작용 한 번당 40분의 업무 시간을 아꼈다. 구글 클라우드가 2025년 12월 19일 공개한 '2026 AI 에이전트 트렌드 보고서'에 담긴 수치다(Google Cloud 공식 발표, 2025.12.19).
